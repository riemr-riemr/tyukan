...
def swap(route, requestnode, taboo_list, best_neighbour):
    max = 0
    min = 1000
    change = []
...
def main(LOOP):
    ...
    print(tabu_list)
    np.savetxt('/home/rei/ドキュメント/data_tyukan/sample.ods', data, delimiter=",")
